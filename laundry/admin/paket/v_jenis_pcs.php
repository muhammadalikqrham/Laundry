...
<div class="pl-5 col-10">
	<div class="enter-admin">
		<h1 class="pt-5 pb-5">Daftar Jenis Paket Satuan</h1>
...
<?php 
	$sql1 = "SELECT * FROM paket WHERE satuan = 'pcs'";
...
{
	$kata=$_POST['kata'];
    $sql="SELECT kode_jenis,nama_jenis,harga_jenis FROM paket WHERE satuan = 'pcs' AND nama like '%$kata%'OR harga  LIMIT $awalData,$jumlahDataPerHalaman";
    echo $koneksi->error;
}
else
	$sql="SELECT kode_jenis,nama_jenis,harga_jenis,satuan FROM paket WHERE satuan = 'pcs' order by kode_jenis DESC LIMIT $awalData,$jumlahDataPerHalaman";
