        ...
        <ul class="list-group">
            ...
            <a href="#submenu1" data-toggle="collapse" aria-expanded="false" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
                <div class="d-flex w-100 justify-content-start align-items-center">
                    ...
                    <span class="menu-collapsed">Akun</span>
                    <span class="submenu ml-auto">
            ...
            <div id='submenu1' class="collapse sidebar-submenu">
                <a href="../kostumer/view_kostumer.php" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed">Konsumen</span>
                </a>
                <a href="../akun/view_akun.php" class="list-group-item list-group-item-action bg-dark text-white">
            ...
            <a href="#submenu3" data-toggle="collapse" aria-expanded="false" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
                <div class="d-flex w-100 justify-content-start align-items-center">
                    ...
                    <span class="menu-collapsed">Paket</span>
                    <span class="submenu ml-auto">
            ...
            <div id='submenu3' class="collapse sidebar-submenu">
                <a href="../paket/v_jenis_kg.php" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed">Kiloan</span>
                </a>
                <a href="../paket/v_jenis_pcs.php" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed">Satuan</span>
                </a>
            </div>  
            ...
            <div id='submenu4' class="collapse sidebar-submenu">
                <a href="../cm/v_cm.php" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed">Cucian Masuk</span>
                </a>
            </div>
